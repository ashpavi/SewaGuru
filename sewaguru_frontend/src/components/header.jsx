      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-3 flex items-center justify-between relative">
        ...
        >
          ...
          <ul className="flex flex-col md:flex-row gap-3 md:gap-6 text-sm font-medium uppercase w-full md:w-auto">
            ...
            <Link to="/ourServices" className="hover:text-yellow-200">Our Services</Link>
            <Link to="/privacyPolicy" className="hover:text-yellow-200">Privacy Policy</Link>
            <Link to="/aboutUs" className="hover:text-yellow-200">About Us</Link>
            <Link to="/contactUs" className="hover:text-yellow-200">Contact Us</Link>
          </ul>

          {/* Desktop Action Buttons */}
          <div className="hidden md:flex flex-col md:flex-row gap-3 mt-4 md:mt-0 md:ml-8 w-full md:w-auto">
            <Link
              to="/sewaguru/sgHomePage"
