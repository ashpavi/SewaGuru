      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-3 flex items-center justify-between relative">
        ...
        >
          ...
          <ul className="flex flex-col md:flex-row gap-3 md:gap-6 text-sm font-medium uppercase w-full md:w-auto">
            ...
            <Link to="/ourServices" className="hover:text-[#104DA3]">Our Services</Link>
            <Link to="/privacyPolicy" className="hover:text-[#104DA3]">Privacy Policy</Link>
            <Link to="/aboutUs" className="hover:text-[#104DA3]">About Us</Link>
            <Link to="/contactUs" className="hover:text-[#104DA3]">Contact Us</Link>
          </ul>
